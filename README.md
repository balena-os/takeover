Takeover is a CLI tool to migrate a running Linux device to balenaOS. It has been used to migrate thousands of Linux devices from distros like RaspberryPi OS and Ubuntu/Debian.
